...
public interface ProfilesModule extends Module {
    ...
    void disconnectProfile(Profile localProfile, ProfileInformation remoteProfileInformation, boolean sendMessage, final ProfSerMsgListener<Boolean> readyListener);
